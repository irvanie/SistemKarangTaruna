...
$sql = "SELECT * FROM pinjam WHERE datediff(tgl_pengembalian,CURRENT_DATE()) <=3 AND datediff(tgl_pengembalian,CURRENT_DATE()) >=0 ";
...
$body = "Terimakasih Kepada Sodara " . $nomor['nama_pinjam'] . " telah melakukan peminjaman *" . $nomor['barang_pinjam']. "* pada Website *Karang Taruna 14* . Sisa waktu pengembalian barang anda *kurang dari 3 hari*,  Tolong Kembalikan pada tanggal *". $nomor['tgl_pengembalian'] .  "* terimakasih :)";
