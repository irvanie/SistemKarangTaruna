...
$sql = "SELECT * FROM pinjam WHERE datediff(tgl_pengembalian,CURRENT_DATE()) <=7 AND datediff(tgl_pengembalian,CURRENT_DATE()) >=4 ";
...
$body = "Terimakasih Kepada Sodara " . $nomor['nama_pinjam'] . " telah melakukan peminjaman *" . $nomor['barang_pinjam']. "* pada website *karang taruna* masa pengembalian barang anda tinggal *7 hari* lagi. Tolong Kembalikan pada tanggal *". $nomor['tgl_pengembalian'] .  "* Terimakasih";
